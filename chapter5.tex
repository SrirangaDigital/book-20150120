...
Practical or non-ideal Op-amps differ from the ideal one. Typical characteristics of the practical Op-amps are as follows.
\begin{enumerate}
...
\begin{figure}[H]
\centering
\includegraphics[scale=.95]{chap4/fig4.3.eps}
...
A very popular and widely used IC version of Op-amp is $\mu A741$ which is an 8 pin IC available in dual-in-line package or DIP package. The pin diagram of\index{Op-amp ($\mu$A-741)!pin diagram of} $\mu A741$ is shown in Fig.~\ref{fig5.3}.
...
(a) & \raisebox{-1cm}{\includegraphics{chap4/exp4.25a.eps}} & (b) & \raisebox{-1cm}{\includegraphics{chap4/exp4.25b.eps}}\\[40pt]
...
\begin{tabular}[t]{@{}l}
$v_{i}= -5\text{V}(DC)$\\[3pt]
$v_{0}= -2\int (-5) dt = +10\,t\text{V}$\\[4pt]
$v_{0}$ is a ramp voltage\\
with a positive slope
\end{tabular}&
\raisebox{-2.2cm}{\includegraphics{chap4/sol4.25a.eps}}
\end{tabular}
...
\begin{tabular}[t]{@{}l}
$v_{i}= 5\text{V}(DC)$\\[3pt]
$v_{0}= -2\int 5dt = -10\,t\text{V}$\\[4pt]
$v_{0}$ is a ramp voltage\\
with a negative slope
\end{tabular}&
\raisebox{-2.2cm}{\includegraphics{chap4/sol4.25b.eps}}
\end{tabular}
...
$v_{0}$   & $= -2\int 2 \sin 4t\,dt$\\[3pt]
         ...
         &  $= \cos 4\,t\,\text{V}$
\end{tabular}&
\raisebox{-2.7cm}{\includegraphics{chap4/sol4.25c.eps}}
\end{tabular}
...
$v_{0}$   & $= -2\int 4t\, dt$\\[3pt]
          ...
          & $= -4\,t^{2}\,\text{V}$
\end{tabular}&
\raisebox{-2.2cm}{\includegraphics{chap4/sol4.25d.eps}}
\end{tabular}
\end{itemize}
\end{solution}
...
$v_{0}$   & $= -\dfrac{d}{dt}[10t]$\\[6pt]
          & $= -10\text{V}(DC)$
\end{tabular} &
\raisebox{-2.1cm}{\includegraphics{chap4/sol4.26a.eps}}
\end{tabular}
